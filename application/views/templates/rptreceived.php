<table width="100%" border="1px">
	...
	@$Count = count($this->Reports_model->printReceivedOrders($IndentNo,$dates));
	?>
	<tr>
	...
	$PackagesReceived = 0;
	$TotalValue = 0;
	 foreach($this->Reports_model->printReceivedOrders($IndentNo,$dates) as $key)
	{

				...
				<div class="col-lg-12">
                    <div class="panel panel-primary" >
                        <div class="panel-heading" >
                        					<div class="row">
						<form role="form" id="neworders" action="Reports/viewStatusReport/">
						<div class="col-lg-3">
                         Status of Orders
                        </div>
						...
						<div class="col-lg-2">
						<input type="submit" class="btn btn-default btn-sm" value="Print Preview" id="viewStatusReport">

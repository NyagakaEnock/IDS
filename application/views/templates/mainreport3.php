				...
				<div class="col-lg-12">
                    <div class="panel panel-primary" >
                        <div class="panel-heading" >
                        					<div class="row">
						<form role="form" id="neworders" action="Reports/ConfirmedNewOrders/">
						<div class="col-lg-3">
                         Confirmed Orders
                        </div>
						...
						<div class="col-lg-2">
						<input type="submit" class="btn btn-default btn-sm" value="Print Preview" id="ConfirmedNewOrders">

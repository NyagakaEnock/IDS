...
<head>
    ...
    <title>KWAL - Procurement</title>
<link href="<?php echo base_url()?>dist/js/select2/select2.min.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url()?>dist/js/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />
    <!-- Bootstrap Core CSS -->
